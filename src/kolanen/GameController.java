...
public class GameController implements Serializable {
	...
	/**
	 * play method is being called from Main class. This starts the game.
	 * @throws Exception
	 */
	public void play() throws Exception {
		...
		// game stops after quit,death and bomb defusing fails/succeeds
	...
	/**
	 * Here we process the command we get from the parser and command classes.
	 * The right command calls the right method.
	 * 
	 * @param command
	 * @return boolean true, if quit is the command.
	 */
	...
	/**
	 * Method defuse only gets called in the last stage. You can't leave this
	 * method until you either lose or win the game.
	 * 
	 * @param command
	 *            contains word1 and word2, in this case defuse and bomb.
	 * @return boolean bombdefuse
	 */
	...
	/**
	 * Loads the saved player1 object
	 */
	...
	/**
	 * The use command for using objects
	 * 
	 * @param command
	 *            contains word use and item+target
	 */
	...
	/**
	 * Take command for picking up items in rooms.
	 * 
	 * @param command
	 *            contains take and item name.
	 */
...
/**
 * This is used for moving between locations.
 * @param command contains words enter and location name.
 */
	private void enterCar(Command command) {
		...
		if (nextCar == null) {
			...
			i--;
				...
				//Checks whether you've entered a "death" room.
			...
			//Enter location exceptions
				...
				System.out.println("\nCHECKPOINT REACHED");
					...
					// if statements regarding the medicine "quest" in car 2
				...
				if (carItems != "" 
						&& !currentLoc.getName().equals(getCar("Toilet").getName())
						&& !currentLoc.equals(getCar("Car4"))
						&& !currentLoc.getName().equals(getCar("Car9").getName())) {
	...
	/**
	 * Is printed when you type "quit" in console.
	 */
...
/**
 * Used for getting locations from cars HashMap
...
/**
 * Method adds Car objects to the HashMap. Key is Car name and value is the Car object.
 * @param name
 * @param description
 */
...
/**
 * Here we add all the locations into the HashMap and set the exits and items.
 * @return
 */
	...
	/**
	 * printCredits is called when typing "quit" or "credits".
	 * @throws Exception
	 */
